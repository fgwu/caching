...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {KV_CACHE_HIT, "rocksdb.uni.cache.kv.hit"},
    {KV_CACHE_MISS, "rocksdb.uni.cache.kv.miss"},
    {KP_CACHE_HIT, "rocksdb.uni.cache.kp.hit"},
    {KP_CACHE_HIT_VALID, "rocksdb.uni.cache.kv.hit.valid"},
    {KP_CACHE_HIT_INVALID, "rocksdb.uni.cache.kv.hit.invalid"},
    {KP_CACHE_MISS, "rocksdb.uni.cache.kp.miss"},
    {ARC_FREQUENCY_REAL_HIT, "rocksdb.uni.cache.frequency.real.hit"},
    {ARC_RECENCY_REAL_HIT, "rocksdb.uni.cache.recency.real.hit"},
    {ARC_FREQUENCY_GHOST_HIT, "rocksdb.uni.cache.frequency.ghost.hit"},
    {ARC_RECENCY_GHOST_HIT, "rocksdb.uni.cache.recency.ghost.hit"},
    {ARC_BOTH_MISS, "rocksdb.uni.cache.both.miss"},
